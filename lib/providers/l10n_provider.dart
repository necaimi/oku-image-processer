...
class L10n {
  static const Map<String, Map<String, String>> _data = {
    'zh': {
      ...
      'pick_files': '选择文件',
      'pick_dir': '选择目录',
      'support_hint': '支持 JPG, PNG, WEBP, ICO',
      'searching': '搜索资源中...',
      'scanning': '正在扫描文件夹',
      'init_engine': '启动引擎',
      'handshake': '建立连接',
      ...
      'nav_watermark': '水印模板',
      'nav_settings': '设置',
      'wm_pick_template': '选择水印模板',
      'manage_templates': '管理模板',
      'wm_template_hint': '选择或创建一个水印模板',
      'wm_template_name': '模板名称',
      'wm_delete': '删除',
      'wm_delete_confirm_title': '确认删除模板？',
      'wm_delete_confirm_content': '这将永久删除此水印模板，此操作不可撤销。',
      'wm_tile_mode': '全屏平铺模式',
      'wm_new_template': '新模板',
      'version': '软件版本',
      'website': '官方网站',
      ...
      'auth_email': '邮箱登录',
      'auth_email_reg': '邮箱注册',
      'auth_email_hint': '请输入电子邮箱',
      'auth_password_hint': '请输入密码',
      'auth_forgot': '忘记密码？',
      'auth_no_account': '还没有账号？',
      'auth_has_account': '已有账号？',
      'auth_qr_hint': '使用微信扫描二维码',
      'auth_qr_expire': '二维码有效期 2 分钟',
      'auth_refresh_qr': '点击刷新二维码',
      'watermark': '水印设置',
      'wm_enable': '启用水印',
      'wm_type': '类型',
      'wm_text': '文本',
    ...
    'en': {
      ...
      'nav_watermark': 'Watermark Templates',
      'wm_pick_template': 'Select Watermark Template',
      'manage_templates': 'Manage Templates',
      'wm_template_hint': 'Select or create a watermark template',
      'wm_template_name': 'Template Name',
      'wm_delete': 'Delete',
      'wm_delete_confirm_title': 'Delete Template?',
      'wm_delete_confirm_content': 'This will permanently delete this watermark template. This action cannot be undone.',
      'wm_tile_mode': 'Full Screen Tile Mode',
      'wm_new_template': 'New Template',
      'version': 'Version',
      ...
      'auth_wechat': 'WeChat Scan',
      'auth_email': 'Email Login',
      'auth_email_reg': 'Email Sign Up',
      'auth_email_hint': 'Enter your email',
      'auth_password_hint': 'Enter your password',
      'auth_forgot': 'Forgot Password?',
      'auth_no_account': "Don't have an account?",
      'auth_has_account': 'Already have an account?',
      'auth_qr_hint': 'Scan QR code with WeChat',
      'auth_qr_expire': 'QR code expires in 2 minutes',
      'auth_refresh_qr': 'Click to refresh QR code',
      'watermark': 'WATERMARK',
